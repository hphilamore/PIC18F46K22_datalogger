...
;USART_test.c,24 :: 		OSCTUNE = 0b00000000; // bit7:  device clock derived from the MFINTOSC or HFINTOSC source
	CLRF        OSCTUNE+0 
;USART_test.c,28 :: 		ANSELC = 0;         // configure all PORTC pins as digital
	CLRF        ANSELC+0 
;USART_test.c,29 :: 		ANSELD = 0;         // configure all PORTD pins as digital
	CLRF        ANSELD+0 
;USART_test.c,30 :: 		delay_ms(1000);     // wait a second
	MOVLW       21
	MOVWF       R11, 0
	MOVLW       75
	MOVWF       R12, 0
...
L_main0:
	...
	BRA         L_main0
	NOP
;USART_test.c,32 :: 		logging_Init();
	CALL        _logging_Init+0, 0
;USART_test.c,128 :: 		while(1){
L_main1:
;USART_test.c,129 :: 		UART1_Write_Text("Hello");
	MOVLW       ?lstr1_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr1_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,130 :: 		Delay_ms(1000);
	MOVLW       21
	MOVWF       R11, 0
	MOVLW       75
	MOVWF       R12, 0
...
L_main3:
	...
	BRA         L_main3
	NOP
;USART_test.c,131 :: 		UART1_Write(13);
	MOVLW       13
...
;USART_test.c,135 :: 		void logging_Init(){
;USART_test.c,137 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV64, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	MOVLW       2
...
;USART_test.c,139 :: 		UART1_Init(9600);   // initialize UART1 module at 9600 baud
	BSF         BAUDCON+0, 3, 0
	MOVLW       1
	MOVWF       SPBRGH+0 
	MOVLW       160
...
;USART_test.c,148 :: 		UART1_Write_Text("Error initializing FAT library!");
...
L_logging_Init5:
;USART_test.c,154 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV4, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	...
	MOVWF       FARG_SPI1_Init_Advanced_transmit_edge+0 
	CALL        _SPI1_Init_Advanced+0, 0
;USART_test.c,155 :: 		UART1_Write_Text("FAT Library initialized");
...
L_logging_Init8:
;USART_test.c,163 :: 		UART1_Write_Text("error creating folder");
...
;USART_test.c,167 :: 		UART1_Write_Text("\r\n\r\nCreate 'Log.txt' file ... ");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,168 :: 		fileHandle = FAT32_Open("Log.txt", FILE_APPEND);
...
;USART_test.c,170 :: 		UART1_Write_Text("OK");
...
L_logging_Init11:
;USART_test.c,172 :: 		UART1_Write_Text("error creating file or file already exists!");
...
;USART_test.c,177 :: 		i = FAT32_Write(fileHandle, "Hello,\r\nThis is a text file created using PIC18F46K22 microcontroller and mikroC compiler.\r\nHave a nice day ...", 113);
	...
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,178 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init14
;USART_test.c,179 :: 		UART1_Write_Text("OK");
...
L_logging_Init14:
;USART_test.c,181 :: 		UART1_Write_Text("writing error");
...
;USART_test.c,194 :: 		UART1_Write_Text("\r\n\r\nReading 'Log.txt' file:");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,195 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,198 :: 		UART1_Write_Text("\r\nOpen 'Log.txt' file ... ");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,199 :: 		fileHandle = FAT32_Open("Log.txt", FILE_READ);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,200 :: 		if(fileHandle != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_logging_Init21
;USART_test.c,201 :: 		UART1_Write_Text("error opening file");
...
L_logging_Init21:
;USART_test.c,204 :: 		UART1_Write_Text("OK");
	MOVLW       ?lstr24_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr24_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,205 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_logging_Init23:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init23
;USART_test.c,207 :: 		UART1_Write_Text("\r\nPrint 'log.txt' file:\r\n\r");
	MOVLW       ?lstr25_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr25_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,208 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_logging_Init24:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init24
;USART_test.c,210 :: 		FAT32_Read(fileHandle, buffer, 113);
	MOVF        _fileHandle+0, 0 
...
;USART_test.c,212 :: 		UART1_Write_Text(buffer);
	MOVLW       _buffer+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_buffer+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,214 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,216 :: 		UART1_Write_Text("\r\n\r\nClosing the file 'log.txt' ... ");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,217 :: 		i = FAT32_Close(fileHandle);
	MOVF        _fileHandle+0, 0 
	MOVWF       FARG_FAT32_Close_fHandle+0 
	CALL        _FAT32_Close+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,218 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init26
;USART_test.c,219 :: 		UART1_Write_Text("OK");
...
L_logging_Init26:
;USART_test.c,221 :: 		UART1_Write_Text("closing error");
...
;USART_test.c,223 :: 		}
L_logging_Init6:
;USART_test.c,225 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
