...
;USART_test.c,13 :: 		void main() {
;USART_test.c,15 :: 		OSCCON = 0b01110000;  // bit7: device enters SLEEP on sleep instruction[0]
	MOVLW       112
	MOVWF       OSCCON+0 
;USART_test.c,21 :: 		OSCTUNE = 0b00000000; // bit7:  device clock derived from the MFINTOSC or HFINTOSC source
	CLRF        OSCTUNE+0 
;USART_test.c,25 :: 		ANSELC = 0;         // configure all PORTC pins as digital
	CLRF        ANSELC+0 
;USART_test.c,26 :: 		ANSELD = 0;         // configure all PORTD pins as digital
	CLRF        ANSELD+0 
;USART_test.c,27 :: 		delay_ms(1000);     // wait a second
	MOVLW       21
	MOVWF       R11, 0
	MOVLW       75
	MOVWF       R12, 0
...
L_main0:
	...
	BRA         L_main0
	NOP
;USART_test.c,30 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV64, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	MOVLW       2
...
;USART_test.c,32 :: 		UART1_Init(9600);   // initialize UART1 module at 9600 baud
	BSF         BAUDCON+0, 3, 0
	MOVLW       1
	MOVWF       SPBRGH+0 
	MOVLW       160
...
L_main1:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main1
;USART_test.c,37 :: 		i = FAT32_Init();
	CALL        _FAT32_Init+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,38 :: 		if(i != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_main2
;USART_test.c,40 :: 		UART1_Write_Text("Error initializing FAT library!");
...
;USART_test.c,41 :: 		}
	GOTO        L_main3
L_main2:
;USART_test.c,46 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV4, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	...
	MOVWF       FARG_SPI1_Init_Advanced_transmit_edge+0 
	CALL        _SPI1_Init_Advanced+0, 0
;USART_test.c,47 :: 		UART1_Write_Text("FAT Library initialized");
	MOVLW       ?lstr3_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr3_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,48 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,52 :: 		if(FAT32_MakeDir("Test Dir") == 0)
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_main5
;USART_test.c,53 :: 		UART1_Write_Text("OK");
	...
	GOTO        L_main6
L_main5:
;USART_test.c,55 :: 		UART1_Write_Text("error creating folder");
	...
	CALL        _UART1_Write_Text+0, 0
L_main6:
;USART_test.c,57 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_main7:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main7
;USART_test.c,59 :: 		UART1_Write_Text("\r\n\r\nCreate 'Log.txt' file ... ");
	MOVLW       ?lstr8_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr8_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,60 :: 		fileHandle = FAT32_Open("Log.txt", FILE_APPEND);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,61 :: 		if(fileHandle == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main8
;USART_test.c,62 :: 		UART1_Write_Text("OK");
	...
	GOTO        L_main9
L_main8:
;USART_test.c,64 :: 		UART1_Write_Text("error creating file or file already exists!");
	...
	CALL        _UART1_Write_Text+0, 0
L_main9:
;USART_test.c,66 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,69 :: 		i = FAT32_Write(fileHandle, "Hello,\r\nThis is a text file created using PIC18F46K22 microcontroller and mikroC compiler.\r\nHave a nice day ...", 113);
	...
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,70 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main11
;USART_test.c,71 :: 		UART1_Write_Text("OK");
	...
	GOTO        L_main12
L_main11:
;USART_test.c,73 :: 		UART1_Write_Text("writing error");
	...
	CALL        _UART1_Write_Text+0, 0
L_main12:
;USART_test.c,75 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,80 :: 		UART1_Write_Text("OK");
	...
	GOTO        L_main15
L_main14:
;USART_test.c,82 :: 		UART1_Write_Text("closing error");
	...
	CALL        _UART1_Write_Text+0, 0
L_main15:
;USART_test.c,84 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,86 :: 		UART1_Write_Text("\r\n\r\nReading 'Log.txt' file:");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,87 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_main17:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main17
;USART_test.c,90 :: 		UART1_Write_Text("\r\nOpen 'Log.txt' file ... ");
	MOVLW       ?lstr20_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr20_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,91 :: 		fileHandle = FAT32_Open("Log.txt", FILE_READ);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,92 :: 		if(fileHandle != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_main18
;USART_test.c,93 :: 		UART1_Write_Text("error opening file");
	...
	GOTO        L_main19
L_main18:
;USART_test.c,96 :: 		UART1_Write_Text("OK");
	MOVLW       ?lstr23_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr23_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,97 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,99 :: 		UART1_Write_Text("\r\nPrint 'log.txt' file:\r\n\r");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,100 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_main21:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main21
;USART_test.c,102 :: 		FAT32_Read(fileHandle, buffer, 113);
	MOVF        _fileHandle+0, 0 
...
;USART_test.c,104 :: 		UART1_Write_Text(buffer);
	MOVLW       _buffer+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_buffer+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,106 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,108 :: 		UART1_Write_Text("\r\n\r\nClosing the file 'log.txt' ... ");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,109 :: 		i = FAT32_Close(fileHandle);
	MOVF        _fileHandle+0, 0 
	MOVWF       FARG_FAT32_Close_fHandle+0 
	CALL        _FAT32_Close+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,110 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main23
;USART_test.c,111 :: 		UART1_Write_Text("OK");
	...
	GOTO        L_main24
L_main23:
;USART_test.c,113 :: 		UART1_Write_Text("closing error");
...
;USART_test.c,115 :: 		}
L_main3:
;USART_test.c,117 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_main25:
	...
	DECFSZ      R11, 1, 1
	BRA         L_main25
;USART_test.c,118 :: 		UART1_Write_Text("\r\n\r\n***** END *****");
	MOVLW       ?lstr28_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr28_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,123 :: 		while(1){
L_main26:
;USART_test.c,124 :: 		UART1_Write_Text("Hello");
	MOVLW       ?lstr29_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr29_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,125 :: 		Delay_ms(1000);
	MOVLW       21
	MOVWF       R11, 0
	MOVLW       75
	MOVWF       R12, 0
...
L_main28:
	...
	BRA         L_main28
	NOP
;USART_test.c,126 :: 		UART1_Write(13);
	MOVLW       13
