...
L_main1:
;USART_test.c,42 :: 		ReadADC_and_Log();
...
;USART_test.c,67 :: 		void ReadADC_and_Log(){
;USART_test.c,70 :: 		R0 = ADC_Get_Sample(0);
	CLRF        FARG_ADC_Get_Sample_channel+0 
	CALL        _ADC_Get_Sample+0, 0
;USART_test.c,71 :: 		WordToStr(R0, R0_);
	MOVF        R0, 0 
...
L_ReadADC_and_Log3:
	...
	BRA         L_ReadADC_and_Log3
	NOP
;USART_test.c,76 :: 		fileHandle = FAT32_Open("Log.txt", FILE_APPEND);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,78 :: 		UART1_Write_Text(R0_);
	MOVLW       ReadADC_and_Log_R0__L0+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(ReadADC_and_Log_R0__L0+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,79 :: 		UART1_Write_Text("\n");
	MOVLW       ?lstr2_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr2_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,80 :: 		i = FAT32_Write(fileHandle, R0_, 6);
	...
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,81 :: 		i = FAT32_Write(fileHandle, "\n", 6);
	MOVF        _fileHandle+0, 0 
	MOVWF       FARG_FAT32_Write_fHandle+0 
	...
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,82 :: 		if(i != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_ReadADC_and_Log4
;USART_test.c,83 :: 		UART1_Write_Text("writing error");
	...
	CALL        _UART1_Write_Text+0, 0
L_ReadADC_and_Log4:
;USART_test.c,87 :: 		i = FAT32_Close(fileHandle);
	MOVF        _fileHandle+0, 0 
...
;USART_test.c,91 :: 		void logging_Init(){
;USART_test.c,93 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV64, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	MOVLW       2
...
;USART_test.c,95 :: 		UART1_Init(9600);   // initialize UART1 module at 9600 baud
	BSF         BAUDCON+0, 3, 0
	MOVLW       1
	MOVWF       SPBRGH+0 
	MOVLW       160
...
L_logging_Init5:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init5
;USART_test.c,101 :: 		i = FAT32_Init();
	CALL        _FAT32_Init+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,102 :: 		if(i != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_logging_Init6
;USART_test.c,104 :: 		UART1_Write_Text("Error initializing FAT library!");
...
L_logging_Init6:
;USART_test.c,110 :: 		SPI1_Init_Advanced(_SPI_MASTER_OSC_DIV4, _SPI_DATA_SAMPLE_MIDDLE, _SPI_CLK_IDLE_LOW, _SPI_LOW_2_HIGH);
	...
	MOVWF       FARG_SPI1_Init_Advanced_transmit_edge+0 
	CALL        _SPI1_Init_Advanced+0, 0
;USART_test.c,111 :: 		UART1_Write_Text("FAT Library initialized");
	MOVLW       ?lstr7_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr7_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,112 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,117 :: 		UART1_Write_Text("OK");
...
L_logging_Init9:
;USART_test.c,119 :: 		UART1_Write_Text("error creating folder");
	...
	CALL        _UART1_Write_Text+0, 0
L_logging_Init10:
;USART_test.c,121 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,124 :: 		UART1_Write_Text("\r\n\r\nCreate 'Log.txt' file ... ");
	...
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,125 :: 		fileHandle = FAT32_Open("Log.txt", FILE_APPEND);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,126 :: 		if(fileHandle == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init12
;USART_test.c,127 :: 		UART1_Write_Text("OK");
...
L_logging_Init12:
;USART_test.c,129 :: 		UART1_Write_Text("error creating file or file already exists!");
	...
	CALL        _UART1_Write_Text+0, 0
L_logging_Init13:
;USART_test.c,131 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
;USART_test.c,134 :: 		i = FAT32_Write(fileHandle, "Hello,\r\nThis is a text file created using PIC18F46K22 microcontroller and mikroC compiler.\r\nHave a nice day ...", 113);
	...
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,135 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init15
;USART_test.c,136 :: 		UART1_Write_Text("OK");
...
L_logging_Init15:
;USART_test.c,138 :: 		UART1_Write_Text("writing error");
	...
	CALL        _UART1_Write_Text+0, 0
L_logging_Init16:
;USART_test.c,140 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_logging_Init17:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init17
;USART_test.c,142 :: 		UART1_Write_Text("\r\nClosing the file 'Log.txt' ... ");
	MOVLW       ?lstr20_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr20_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,143 :: 		i = FAT32_Close(fileHandle);
	MOVF        _fileHandle+0, 0 
	MOVWF       FARG_FAT32_Close_fHandle+0 
	CALL        _FAT32_Close+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,144 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init18
;USART_test.c,145 :: 		UART1_Write_Text("OK");
...
L_logging_Init18:
;USART_test.c,147 :: 		UART1_Write_Text("closing error");
...
L_logging_Init20:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init20
;USART_test.c,151 :: 		UART1_Write_Text("\r\n\r\nReading 'Log.txt' file:");
...
L_logging_Init21:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init21
;USART_test.c,155 :: 		UART1_Write_Text("\r\nOpen 'Log.txt' file ... ");
	MOVLW       ?lstr24_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr24_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,156 :: 		fileHandle = FAT32_Open("Log.txt", FILE_READ);
	...
	MOVF        R0, 0 
	MOVWF       _fileHandle+0 
;USART_test.c,157 :: 		if(fileHandle != 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSC       STATUS+0, 2 
	GOTO        L_logging_Init22
;USART_test.c,158 :: 		UART1_Write_Text("error opening file");
...
L_logging_Init22:
;USART_test.c,161 :: 		UART1_Write_Text("OK");
...
L_logging_Init24:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init24
;USART_test.c,164 :: 		UART1_Write_Text("\r\nPrint 'log.txt' file:\r\n\r");
	MOVLW       ?lstr28_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr28_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,165 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_logging_Init25:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init25
;USART_test.c,167 :: 		FAT32_Read(fileHandle, buffer, 113);
	MOVF        _fileHandle+0, 0 
...
;USART_test.c,169 :: 		UART1_Write_Text(buffer);
	MOVLW       _buffer+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_buffer+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,171 :: 		delay_ms(2000);     // wait 2 seconds
	MOVLW       41
	MOVWF       R11, 0
	MOVLW       150
	MOVWF       R12, 0
...
L_logging_Init26:
	...
	DECFSZ      R11, 1, 1
	BRA         L_logging_Init26
;USART_test.c,173 :: 		UART1_Write_Text("\r\n\r\nClosing the file 'log.txt' ... ");
	MOVLW       ?lstr29_USART_test+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr29_USART_test+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;USART_test.c,174 :: 		i = FAT32_Close(fileHandle);
	MOVF        _fileHandle+0, 0 
	MOVWF       FARG_FAT32_Close_fHandle+0 
	CALL        _FAT32_Close+0, 0
	MOVF        R0, 0 
	MOVWF       _i+0 
;USART_test.c,175 :: 		if(i == 0)
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_logging_Init27
;USART_test.c,176 :: 		UART1_Write_Text("OK");
...
L_logging_Init27:
;USART_test.c,178 :: 		UART1_Write_Text("closing error");
