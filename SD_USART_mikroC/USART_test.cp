...
#line 56 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
__HANDLE fileHandle;
char buffer[114];
short i;
...
void main() {
 ...
 ReadADC_and_Log();
#line 113 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 }
}
...
void logging_Init(){
 ...
 delay_ms(1000);
#line 190 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 UART1_Write_Text("\r\n\r\nWrite test code to file :  This_is_a_text_file_created_using_PIC18F46K22_microcontroller");
 fileHandle = FAT32_Open("Log.txt", FILE_APPEND);
#line 202 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 i = FAT32_Write(fileHandle, "\r\nThis_is_a_text_file_created_using_PIC18F46K22_microcontroller_and_mikroC_compiler.\r\n", 113);
#line 210 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 delay_ms(1000);


 i = FAT32_Close(fileHandle);
#line 223 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 ...
 UART1_Write_Text("\r\n\r\nClosing the file ... ");
 i = FAT32_Close(fileHandle);
#line 255 "//Mac/Home/Documents/Code/microC/PIC18F46K22_datalogger/SD_USART_mikroC/USART_test.c"
 }
 }
